...
오늘은 **자동화 배포와 에러 알림을 적용한 파일럿 프로젝트의 경험**과,
...
이번 **나만의 프로젝트를 진행하며 적용된 자동화 기능들이 참 편리하고 마법**같다고 느꼈습니다.
...
하지만 **의도한대로 적용되기까지 겪은 과정들에 난관**이 참 많았는데요.
...
**안정적으로 구조가 적용될 때 까지 겪었던 난관들에 대해서 얘기**해보려합니다.  
...
**그런데 `이펙티브 엔지니어`를 읽으며 든 생각과 적용하고 나서 얻게 된 이점을 정리**해보니,
